def main():
    ...
    # Ours marker
    ax.scatter([156], [32.16], alpha=1.0, marker='*', c='r', s=300)
    ax.scatter([357], [32.30], alpha=1.0, marker='*', c='r', s=700)
    ...
    # Legend (removed invalid handleheight)
    h = [
    ...
    # Tick label sizes as numbers, not strings
    ...
    # Save BEFORE showing
    fig.savefig('model_complexity_cmp_bsrn.png', dpi=300, bbox_inches='tight')
    plt.show()
