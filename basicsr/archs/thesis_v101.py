...
#         x4_path0 = self.spatial_conv3(x3_path0)
#         ll4_path1 = self.freq_conv3(ll3_path1)

#         x5_path0 = self.spatial_encoder2(self.spatial_conv3(x4_path0))
#         ll5_path1 = self.freq_encoder2(self.freq_conv3(ll4_path1), lh0_path1, hl0_path1, hh0_path1)

#         x6_path1 = self.idwt((ll5_path1, [torch.stack([lh0_path1, hl0_path1, hh0_path1], 2)]))

#         y = x + self.final_proj(torch.cat([x5_path0, x6_path1], 1))
